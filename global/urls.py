...
urlpatterns = [
    ...
    path('addhistory/<int:tid>', views.addHistory, name="addhistory"),
    path('addtheory/<int:tid>', views.addTheory, name="addtheory"),
    path('addlectures/<int:tid>', views.addLectures, name="addlectures"),
